...
class TabForwads extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => this.props.resetTeam('Forward')}>
                  <Text
                    style={[
                      styles.yellowButtonSmallText,
                      { fontSize: 16, lineHeight: 19 },
  ...
  _getFavoriteOption = (item) => {
    return (
      <View
        ...
        <TouchableOpacity
          onPress={() => {
            this.props.showTeamDailogue(item, 'Forward');
          }}>
        ...
        {item.selected && (
          <TouchableOpacity
            onPress={() => this.props.showRemoveDialogue(item, 'Forward')}>
