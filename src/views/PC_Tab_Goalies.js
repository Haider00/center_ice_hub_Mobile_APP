...
class PC_Tab_Goalies extends React.Component {
  constructor(props) {
    super(props);
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => this.props.allReset('Goalies')}>
                  <Text
                    style={[
                      styles.yellowButtonSmallText,
                      { fontSize: 16, lineHeight: 19 },
  ...
  _selecetOption = (item) => {
    if (item.droupDown === 1) {
      ...
      this.props.changeSeasonFilter(item.name, 'Goalies');
    } else if (item.droupDown === 2) {
      this.setState({ droupDown2Selected: item.name, showDroupDown2: false });
      this.props.changeTimeFilter(item.name, 'Goalies');
    ...
    return (
      <View
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => this.props.selectPlayer(item, 'Goalies')}>
        ...
        {item.selected && (
          <TouchableOpacity
            onPress={() => this.props.resetPlayer(item, 'Goalies')}>
              ...
              <View style={styles.containerRowStart}>
                ...
                <View style={{ marginLeft: 10, marginRight: 25 }}>
                  ...
                  <Text
                    ...
                    Start adding your favorite goalies to compare them. Tap the
