...
class TabDefensive extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => this.props.resetTeam('Defenseman')}>
                  <Text
                    style={[
                      styles.yellowButtonSmallText,
                      { fontSize: 16, lineHeight: 19 },
  ...
  _getFavoriteOption(item) {
    return (
      <View
        ...
        <TouchableOpacity
          onPress={() => this.props.showTeamDailogue(item, 'Defenseman')}>
        ...
        {item.selected && (
          <TouchableOpacity
            onPress={() => this.props.showRemoveDialogue(item, 'Defenseman')}>
        ...
        <View style={[styles.containerRowCenter, { marginTop: 20 }]}>
          <View style={{ marginLeft: '5%', marginRight: '1%', width: '45%' }}>
            <TouchableOpacity
              ...
              <Text style={styles.roundGrayButtonText}>Reset Defenseman</Text>
            </TouchableOpacity>
          </View>
